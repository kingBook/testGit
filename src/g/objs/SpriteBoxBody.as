package g.objs{
	...
	public class SpriteBoxBody extends GameObject{
		public static function create(sprite:Sprite,userDataType:String=null,isSensor:Boolean=false,bodyType:uint=0):SpriteBoxBody{
			var game:Game=Game.getInstance();
			var info:*={};
			info.userDataType=userDataType;
			info.isSensor=isSensor;
			info.bodyType=bodyType;
			info.body=Box2dUtil.createBoxFromSprite(sprite,game.global.curWorld,MyData.ptm_ratio);
