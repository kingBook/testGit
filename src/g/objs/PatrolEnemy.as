package g.objs{
	...
	public class PatrolEnemy extends MovableObject{
		...
		public static function create():PatrolEnemy{
			var game:Game=Game.getInstance();
			var info:*={};
			info.body=Box2dUtil.createRoundBox(40,60,100,100,game.global.curWorld,MyData.ptm_ratio,5,10);
