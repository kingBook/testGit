package g.objs{
	...
	public class Teleport extends SwitcherCtrlObj{
		...
		public static function create(childMc:MovieClip,viewDefName:String,isMovieClipView:Boolean=false,openFrames:Vector.<int>=null,closeFrames:Vector.<int>=null):void{
			...
			*/
			...
			//info.body=Box2dUtil.createCircle(int(childMc.width)>>1,childMc.x,childMc.y,game.global.curWorld,MyData.ptm_ratio);
			info.body=Box2dUtil.createBox(childMc.width,childMc.height,childMc.x,childMc.y,game.global.curWorld,MyData.ptm_ratio);
