package g.objs{
	...
	public class TeleportSwapButton extends Switcher{
		...
		public static function create(childMc:MovieClip,viewDefName:String):void{
			...
			*/
			var info:*={};
			info.body=Box2dUtil.createCircle(childMc.width>>1,childMc.x,childMc.y,game.global.curWorld,MyData.ptm_ratio);
		...
		override protected function update():void{
			var mouseX:Number=_game.global.nativeStage.mouseX/MyData.ptm_ratio;
			var mouseY:Number=_game.global.nativeStage.mouseY/MyData.ptm_ratio;
