package g.objs{
	...
	public class Seesaw extends MovableObject{
		...
		static public function create(childMc:MovieClip):void{
			...
			var body:b2Body=game.global.curWorld.CreateBody(bodyDef);
		...
		override protected function init(info:* = null):void{
			...
			jointDef.Initialize(_body,_game.global.curWorld.GetGroundBody(),_body.GetWorldCenter());
			_game.global.curWorld.CreateJoint(jointDef);
